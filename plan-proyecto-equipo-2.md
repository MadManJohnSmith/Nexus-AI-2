# Documento del Equipo 2: Acuerdos, Tesis y Evidencias
## Enfoque, Responsabilidades y Historias de Usuario

Este documento de trabajo define de manera rigurosa las responsabilidades, historias de usuario y criterios de aceptación específicos para el **Equipo 2: Acuerdos, Tesis y Evidencias**.

### Rol del Equipo 2 en el Proyecto:
El **Equipo 2** se encarga de la lógica fina de permisos de acceso, el registro detallado de observaciones de tutoría, el núcleo del módulo de acuerdos y compromisos resultantes, la carga y validación de evidencias físicas/enlaces del sistema y el control del avance longitudinal de investigación de la tesis doctoral. También lidera el motor de alertas de seguimiento académico incompleto.

### Interacciones y Dependencias Técnicas:
1. **Modelado de Datos de Tutorías (con Equipo 1):** Las observaciones (HU-09) y los acuerdos (HU-11) desarrollados por el Equipo 2 dependen de manera directa de la existencia de una sesión de tutoría previa (HU-07) registrada por el módulo del Equipo 1.
2. **Entidades del Expediente (con Equipo 1):** El registro del avance de tesis (HU-15) y la carga de evidencias (HU-21) requieren asociarse obligatoriamente a un estudiante (HU-03) y a un semestre (HU-05) gestionados por los componentes del Equipo 1.
3. **Línea de Tiempo e Integración (con Equipo 3):** Los datos generados por el Equipo 2 sobre acuerdos (HU-13), avance de tesis (HU-15) y evidencias (HU-21, HU-22) alimentan de forma crítica a la Línea de Tiempo Longitudinal (HU-23) y al Dashboard del Coordinador (HU-24) administrados por el Equipo 3.
4. **Alertas y Notificaciones (con Equipo 3):** Las alertas de acuerdos próximos a vencer/vencidos (HU-25) desarrolladas por el Equipo 3 se disparan a partir de las fechas compromiso de acuerdos (HU-12) y los estados actualizados (HU-13) manejados por el Equipo 2.

---

## Historias de Usuario y Criterios de Aceptación del Equipo 2
...
### HU-02 — Controlar acceso por rol
- **Definición:** Como administrador, quiero asignar roles y permisos, para garantizar que cada usuario sólo acceda a la información autorizada.
...
- **Criterios de Aceptación:**
  - **CA-04.1:** Sólo podrán seleccionarse usuarios con roles compatibles.
  - **CA-04.2:** Las asociaciones deberán quedar vinculadas al expediente.
  - **CA-04.3:** Los participantes autorizados podrán posteriormente seleccionarse en las tutorías.

### HU-09 — Registrar avances y observaciones
- **Definición:** Como asesor o coasesor, quiero documentar avances, temas revisados, observaciones y comentarios, para conservar el contenido académico de la sesión.
- **Criterios de Aceptación:**
  - **CA-09.1:** Se podrán registrar múltiples temas o avances en una misma tutoría.
  - **CA-09.2:** Las observaciones deberán identificar a su autor.
  - **CA-09.3:** La información permanecerá asociada a la tutoría original.

### HU-11 — Crear acuerdos
- **Definición:** Como asesor, quiero generar acuerdos durante una tutoría, para convertir las decisiones en compromisos verificables.
- **Criterios de Aceptación:**
  - **CA-11.1:** Cada acuerdo deberá estar asociado a una tutoría.
  - **CA-11.2:** Una tutoría podrá tener cero, uno o varios acuerdos.
  - **CA-11.3:** Cada acuerdo deberá conservar su descripción.

### HU-12 — Asignar responsable y fecha
- **Definición:** Como asesor, quiero asignar responsable y fecha compromiso a un acuerdo, para hacer explícita la responsabilidad.
- **Especificaciones Técnicas:**
  - El responsable asignado debe ser obligatoriamente una persona previamente asociada al seguimiento del estudiante.
  - La fecha compromiso debe ser válida.

### HU-13 — Actualizar estado
- **Definición:** Como responsable de un acuerdo, quiero actualizar su estado, para informar el progreso.
- **Especificaciones de Negocio:**
  - **Estados iniciales obligatorios:** Pendiente -> En proceso -> Concluido.
  - **Estado Vencido:** Se determina de forma automática por el sistema cuando la fecha de compromiso se sobrepasa sin que esté marcado como concluido.
  - Todo cambio de estado debe registrar obligatoriamente la fecha del movimiento y el identificador de usuario correspondiente.

### HU-15 — Registrar avance de tesis
- **Definición:** Como estudiante o asesor autorizado, quiero registrar avance de tesis, para documentar el progreso de investigación.
- **Especificaciones de Avances:** Se deben contemplar las siguientes áreas temáticas de investigación:
  - Protocolo, estado del arte, marco teórico, metodología, desarrollo, recolección de datos, análisis, redacción, capítulos, porcentaje aproximado de avance.
- **Criterios de Aceptación:**
  - **CA-15.1:** Todo registro de avance deberá asociarse estrictamente a estudiante y semestre académico.
  - **CA-15.2:** El porcentaje aproximado de avance deberá permanecer dentro del rango numérico permitido (0% - 100%).
  - **CA-15.3:** Deberá poder consultarse de forma clara el registro previo para evitar perder la evolución histórica del alumno.

### HU-16 — Comparar avance por semestre
- **Definición:** Como asesor o coordinador, quiero comparar el avance de tesis entre semestres, para identificar evolución o estancamiento.
- **Especificaciones Técnicas:**
  - El sistema deberá mostrar los valores históricos completos y no sustituirlos simplemente por el valor del porcentaje más reciente.

### HU-21 — Cargar evidencia
- **Definición:** Como usuario autorizado, quiero cargar una evidencia, para respaldar una actividad registrada.
- **Criterios de Aceptación:**
  - **CA-21.1:** La evidencia física deberá vincularse obligatoriamente a un estudiante, una actividad académica concreta, un semestre y una fecha de registro.
  - **CA-21.2:** Se validarán estrictamente los tipos de archivo y tamaños máximos permitidos en la configuración del servidor.
  - **CA-21.3:** Un usuario sin autorización explícita sobre el expediente protegido no deberá poder descargar el archivo de evidencia.

### HU-22 — Registrar evidencia mediante enlace
- **Definición:** Como estudiante, quiero registrar DOI o URL, para utilizar evidencia externa sin cargar necesariamente un archivo.
- **Especificaciones Técnicas:**
  - El enlace externo (DOI/URL) registrado deberá quedar perfectamente asociado a una actividad académica concreta.

### HU-26 — Alertar falta de seguimiento
- **Definición:** Como coordinador, quiero identificar estudiantes con seguimiento incompleto, para intervenir oportunamente.
- **Especificaciones de Reglas de Alerta:** Debe identificar automáticamente los siguientes casos:
  - Periodo prolongado sin sesiones de tutorías registradas.
  - Tutoría programada muy próxima.
  - Evidencia obligatoria requerida ausente.
  - *Mitigación:* Las reglas de tiempo deberán ser configurables de forma centralizada y no codificadas en múltiples pantallas.
