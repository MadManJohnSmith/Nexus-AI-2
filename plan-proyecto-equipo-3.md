# Documento del Equipo 3: Seguimiento Longitudinal y Coordinación
## Enfoque, Responsabilidades y Historias de Usuario

Este documento de trabajo define de manera rigurosa las responsabilidades, historias de usuario y criterios de aceptación específicos para el **Equipo 3: Seguimiento Longitudinal y Coordinación**.

### Rol del Equipo 3 en el Proyecto:
El **Equipo 3** asume la responsabilidad primordial de integración funcional del sistema. No se dedica al desarrollo de los módulos de base de datos aislados, sino a construir las vistas consolidadas, la Línea de Tiempo Longitudinal, el Dashboard del Coordinador de posgrado, el motor de alertas internas sobre vencimiento de compromisos, el registro de estancias doctorales y otros productos académicos, así como la generación del Reporte Integral del estudiante. Su papel es asegurar la experiencia unificada del sistema.

### Interacciones y Dependencias Técnicas:
1. **Consumo de Datos de Tutorías (con Equipo 1):** El expediente (HU-06) y la línea de tiempo (HU-23) consumen directamente las tutorías registradas (HU-07) y las reuniones futuras (HU-10) del Equipo 1.
2. **Consumo de Compromisos y Tesis (con Equipo 2):** Para construir el Dashboard (HU-24), las alertas de acuerdos (HU-25) y la consulta de pendientes/vencidos (HU-14), el Equipo 3 depende de manera intensiva de la información del avance de tesis (HU-15) y del estado y fechas compromiso de acuerdos (HU-11, HU-12, HU-13) desarrollados por el Equipo 2.
3. **Interdependencia con Exportación (con Equipo 1):** El Reporte Integral por estudiante (HU-27) generado por el Equipo 3 proporciona la estructura de datos que posteriormente el Equipo 1 utilizará en la HU-28 para su exportación física a Excel o PDF.

---

## Historias de Usuario y Criterios de Aceptación del Equipo 3
...
### HU-06 — Consultar expediente
- **Definición:** Como usuario autorizado, quiero consultar el expediente del estudiante, para conocer su situación académica.
- **Especificaciones de Visualización:** Debe mostrar de manera clara e inmediata al menos:
  - Semestre académico actual.
  - Asesor y coasesor asignados.
  - Fecha de última tutoría registrada.
  - Listado de acuerdos y compromisos abiertos.
  - Estado del avance de tesis doctoral.
  - Actividad académica registrada recientemente.

### HU-14 — Consultar acuerdos pendientes y vencidos
- **Definición:** Como estudiante, asesor o coordinador, quiero consultar compromisos abiertos, para identificar trabajo que requiere atención.
- **Especificaciones de Filtros Mínimos:** Debe permitir filtrar al menos por:
  - Estudiante.
  - Semestre académico.
  - Estado del acuerdo (Pendiente, En Proceso, Concluido, Vencido).
  - Persona responsable.
  - Fecha compromiso de entrega.

### HU-19 — Registrar estancia doctoral
- **Definición:** Como estudiante, quiero registrar una estancia doctoral, para documentar movilidad y resultados.
- **Especificaciones de Registro:** Debe permitir la captura obligatoria de:
  - Institución de destino, país, periodo de duración de la estancia, persona responsable en destino, objetivos académicos, actividades a realizar y resultados obtenidos.

### HU-20 — Registrar otro producto
- **Definición:** Como estudiante, quiero registrar otros productos académicos, para documentar resultados no cubiertos por publicaciones ordinarias.
- **Especificaciones Técnicas (Clasificación Could):**
  - Tipos iniciales contemplados: capítulo de libro, software desarrollado, prototipo físico, base de datos de investigación, propiedad intelectual/patente, proyecto de investigación, u otro.
  - *Nota:* Al ser una funcionalidad clasificada como "Could" (Podría ser), se priorizará su exclusión en caso de desbordamientos de tiempo de desarrollo en el Sprint 4.

### HU-23 — Línea de tiempo longitudinal
- **Definición:** Como estudiante, asesor o coordinador, quiero visualizar la trayectoria cronológicamente, para conocer cómo ha evolucionado el doctorando.
- **Especificaciones de Integración Mínima:** Debe integrar cronológicamente en un solo timeline interactivo:
  - Sesiones de tutorías registradas.
  - Acuerdos y compromisos generados.
  - Avances de tesis doctoral ingresados.
  - Evidencias cargadas (archivos y enlaces externos).
  - *Fase 2 (Sprints posteriores):* Incorporará producción científica, participación en congresos y estancias registradas.
  - **Importancia:** Esta historia es uno de los hitos de integración técnica más críticos de todo el proyecto.

### HU-24 — Dashboard del coordinador
- **Definición:** Como coordinador, quiero una vista global de estudiantes, para identificar casos que requieren atención inmediata.
- **Especificaciones de Indicadores Operativos Básicos:** Debe mostrar de forma gráfica o consolidada:
  - Total de estudiantes activos en el posgrado.
  - Total de acuerdos actualmente pendientes.
  - Total de acuerdos vencidos acumulados.
  - Estudiantes identificados sin tutorías recientes en el periodo.
  - Gráfica consolidada de avances de tesis.
  - Listado de actividades académicas próximas a realizarse.

### HU-25 — Alertar acuerdos
- **Definición:** Como responsable de un acuerdo, quiero conocer compromisos próximos a vencer o vencidos, para poder actuar oportunamente.
- **Especificaciones de Negocio:**
  - Para este ciclo escolar o alcance del proyecto, son suficientes y obligatorias las **alertas visuales dentro de la propia plataforma web**.
  - No es necesario, bajo ninguna circunstancia, programar integraciones con correo electrónico, mensajes SMS o mensajería de WhatsApp para el Sprint 3.

### HU-27 — Reporte integral
- **Definición:** Como coordinador o asesor, quiero generar un reporte por estudiante, para consultar y compartir su trayectoria.
- **Especificaciones de Contenido:** El reporte debe consolidar de forma organizada la siguiente información:
  - Historial de tutorías, acuerdos y compromisos, avance de tesis, publicaciones registradas, participación en congresos/coloquios, estancias del estudiante y enlaces/archivos de evidencias asociadas.
